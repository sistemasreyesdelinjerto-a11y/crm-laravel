<section id="encabezado"
    class="py-10 px-6 bg-gradient-to-r from-gray-100 via-white to-gray-100 mb-12 border-t border-gray-300">
            ...
            <div class="relative">
                ...
                <div id="blogScrollContainer"
                    ...
                    @foreach ($blogs as $blog)
                        <div
                            class="min-w-[350px] bg-white shadow-lg rounded-lg p-6 hover:shadow-xl transition-shadow border border-gray-100">
                            <!-- Imagen del blog -->
                            @if ($blog->imagen)

<div x-data="{ sidebarOpen: false }" class="relative min-h-screen flex">
    ...
    <!-- Sidebar -->
    <aside
        class="w-64 bg-[#1C6C73] text-white flex flex-col fixed inset-y-0 left-0 transform transition-transform duration-300 ease-in-out z-40
        ...
        <nav class="p-4 space-y-2 overflow-y-auto flex-1">
            ...
            <!-- Inventario -->
            <a href="{{ route('panel.inventario.index') }}"
                class="flex items-center p-2 rounded-lg hover:bg-[#C8BAAF]">

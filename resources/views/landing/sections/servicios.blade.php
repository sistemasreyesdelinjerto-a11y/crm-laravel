                ...
                <div class="swiper-wrapper">
                    @foreach ($servicios as $servicio)
                        <div class="swiper-slide">
                            <div
                                class="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 h-[550px] flex flex-col">
                                ...
                                @else
                                    <div
                                        class="w-full h-72 bg-gray-200 flex items-center justify-center text-gray-400 text-lg">
                                        Sin imagen
                                    </div>
                                @endif

      ...
      <ul class="hidden md:flex items-center gap-8 text-lg font-semibold text-beigeClaro">
        ...
        <li class="relative group">
          ...
          <ul class="absolute left-1/2 -translate-x-1/2 mt-3 w-60 bg-beigeCalido text-verdeOscuro rounded-3xl shadow-2xl opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-all duration-5000 transform -translate-y-2 group-hover:translate-y-0">
            <li><a href="{{ Route('landing.santafe') }}" class="block px-5 py-3 hover:bg-verdeClaro/20 rounded-xl transition-all duration-300">Santa Fe</a></li>
            <li><a href="{{ Route('landing.pedregal') }}" class="block px-5 py-3 hover:bg-verdeClaro/20 rounded-xl transition-all duration-300">Predregal</a></li>
            <li><a href="{{ Route('landing.queretaro') }}" class="block px-5 py-3 hover:bg-verdeClaro/20 rounded-xl transition-all duration-300">Querétaro</a></li>
          </ul>
        </li>
